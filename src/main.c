...
static void mostrarMenu(void) {
    ...
    printf("5 - Remover voo pelo numero\n");
    printf("6 - Verificar rota direta\n");
    printf("7 - Imprimir matriz esparsa\n");
    printf("8 - Listar voos que saem de um aeroporto\n");
    printf("9 - Listar trajetos entre aeroportos\n");
    printf("0 - Sair\n");
}
    ...
    do {
        ...
        switch (opcao) {
            ...
            case 5: {
                ...
                numeroVoo = lerInteiro("Numero do voo a remover: ");

                if (removerRotaPorNumero(grafo, numeroVoo)) {
            ...
            case 8: {
                ...
                lerTexto("Codigo do aeroporto de origem: ", origem, TAM_ENTRADA_CODIGO);
                listarVoosSaindoDe(grafo, origem);
                break;
            }
            ...
            case 9: {
                ...
                lerTexto("Codigo do aeroporto de origem: ", origem, TAM_ENTRADA_CODIGO);
                lerTexto("Codigo do aeroporto de destino: ", destino, TAM_ENTRADA_CODIGO);
                listarTrajetos(grafo, origem, destino);
                break;
            }
